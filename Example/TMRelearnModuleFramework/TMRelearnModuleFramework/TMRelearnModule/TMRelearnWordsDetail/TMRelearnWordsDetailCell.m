...
- (void)layoutUI {
    ...
    tipsLabel.backgroundColor = BACKGROUND_COLOR;
    ...
    [self.voiceButton setImage:[UIImage ap_imageNamed:@"ap_words_icon_voice_play_4" atDir:@"APWords"] forState:UIControlStateNormal];
    [self.voiceButton setImage:[UIImage ap_imageNamed:@"ap_words_icon_voice_play_4" atDir:@"APWords"] forState:UIControlStateHighlighted];
    self.voiceButton.imageView.animationImages = @[
//                                                   [UIImage ap_imageNamed:@"ap_words_icon_voice_play_1" atDir:@"APWords"],
//                                                   [UIImage ap_imageNamed:@"ap_words_icon_voice_play_2" atDir:@"APWords"],
//                                                   [UIImage ap_imageNamed:@"ap_words_icon_voice_play_3" atDir:@"APWords"],
//                                                   [UIImage ap_imageNamed:@"ap_words_icon_voice_play_4" atDir:@"APWords"]
                                                   ];
