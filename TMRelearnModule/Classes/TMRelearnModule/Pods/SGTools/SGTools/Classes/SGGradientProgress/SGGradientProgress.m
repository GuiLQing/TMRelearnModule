//
//  SGGradientProgress.m
//  SGGradientProgress
//
//  Created by sg on 2018/2/6.
...
@implementation SGGradientProgress
...
- (void)initialization {
    ...
    NSBundle *resourcesBundle = [NSBundle bundleWithPath:[mainBundle pathForResource:@"SGGradientProgress" ofType:@"bundle"]];
