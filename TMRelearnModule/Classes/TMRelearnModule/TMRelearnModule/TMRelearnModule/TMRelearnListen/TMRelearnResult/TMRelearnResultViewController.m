...
- (instancetype)init
{
    ...
    if (self) {
        ...
        for (NSInteger i = 0; i < 5; i ++) {
            ...
            imageView.image = [UIImage tm_imageNamed:@"et_result_icon_star_normal"];
...
- (void)setStarCount:(NSInteger)starCount {
    ...
    for (NSInteger i = 0; i < starCount; i ++) {
        ...
        imageView.image = [UIImage tm_imageNamed:@"et_result_icon_star_highlight"];
    }
}
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        .g_backgroundImage([UIImage tm_imageNamed:@"et_result_icon_score"], UIControlStateNormal)
        ...
        .g_backgroundImage([UIImage tm_imageNamed:@"et_result_icon_time"], UIControlStateNormal)
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        bottomIV.image = [UIImage tm_imageNamed:@"et_result_icon_button_shadow"];
        ...
        exitBottomIV.image = [UIImage tm_imageNamed:@"et_result_icon_button_shadow"];
...
- (void)resetDataSource {
    ...
    [self.scoreView.scoreButton setTitle:[NSString stringWithFormat:@"%ld", trainingScore] forState:UIControlStateNormal];
//    [self.scoreView.timeButton setTitle:[NSDate secondsTommss:self.trainingTimeLength] forState:UIControlStateNormal];
...
- (void)layoutUI {
    ...
    self.bgIV.image = [UIImage tm_imageNamed:@"et_result_icon_bg"];
    ...
    self.bigFlowerIV.image = [UIImage tm_imageNamed:@"et_result_icon_flower_big"];
    ...
    self.smallFlowerIV.image = [UIImage tm_imageNamed:@"et_result_icon_flower_small"];
    ...
    .g_image([UIImage tm_imageNamed:@"et_navi_icon_back"], UIControlStateNormal)
